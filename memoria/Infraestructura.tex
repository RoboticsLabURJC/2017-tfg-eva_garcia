...
\subsection{Placa Arduino}\label{subsec:placa}
...
\subsubsection{Actuadores}\label{ssubsec:actuadores}
...
\par Este lenguaje, y la interfaz gráfica, es una perfecta primera aproximación a
