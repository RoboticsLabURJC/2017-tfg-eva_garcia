\chapter{Aplicación educativa}\label{cap:aplicationEducativa}
...
Las prácticas descritas para la segunda parte son una transcripción de algunas prácticas de Scratch (las relativas a comportamientos), adaptadas a los periféricos disponibles en PyBo-Kids-2.0. 
\section{Objetivos docentes: metodología}\label{sec:metodología}
...
\subsubsection{Actuadores} \label{subsubsec:actuadores}
...
\subsubsection{Sensores} \label{subsubsec:sensores}
...
\end{description}
\subsubsection{Comportamientos}\label{subsubsec:comportamientos}
...
\section{Segunda etapa: PyBo-Kids-2.0 en Python}\label{sec:Python}
...
\begin{description}
	...
	Una vez hayan usado una vez el método y que puedan comprobar que funciona, pasaremos a desarrollar las carreras de obstáculos que se comentó como ''Ejercicio extra'' en \ref{ej:carreras}.
...
Después de estos ejercicios, los alumnos estarán capacitados para hacer el resto de ejercicios de la sección de Scratch (\ref{sec:scratch}). Lo más importante es guiarles en el proceso Agile e intentar que no se salten pasos por falsa confianza, y en la posible ayuda que necesiten sobre el lenguaje y su sintaxis. 