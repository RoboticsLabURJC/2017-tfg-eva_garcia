...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.8]{camion.png}	
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.7]{variableluz.png}	
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.7]{lucesautomaticas.png}	
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.7]{huyeluz.png}	
...
\begin{description}
	...
	\begin{figure}[H]
		\includegraphics[scale=0.6]{laberintoSolucion.png}
		\centering
